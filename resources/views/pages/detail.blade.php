...
<div class="page-content page-details">
  ...
  <!-- untuk menampilkan gambar transisi muncul, ambil dari variabel dan key -->
            <img 
     ...
     <div class="container">
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="owner">By Diki Setiawan</div>
          <div class="price">$1,409</div>
         </div>
        <div class="col-lg-2" data-aos="zoom in">
          <a href="/cart.html" class="btn btn-success px-4 text-white btn-block mb-0">Add to Cart</a>
        </div>
      </div>
     </div>
    </section>
      ...
      <div class="row">
        <div class="col-12 col-lg-8">
          <ul class="list-unstyled">
            <li class="media">
              <img src="/images/icons-testimonial-1.png" alt="" class="rounded-circle mr-3">
            ...
            <li class="media">
              <img src="/images/icons-testimonial-2.png" alt="" class="rounded-circle mr-3">
              <div class="media-body">
            ...
            <li class="media">
              <img src="/images/icons-testimonial-3.png" alt="" class="rounded-circle mr-3">
              <div class="media-body">
